...
export enum AppPermission {
  ...
  CREATE_FOOT_ANALYSIS        = 'CREATE_FOOT_ANALYSIS',
  VIEW_FOOT_ANALYSIS          = 'VIEW_FOOT_ANALYSIS',
  UPDATE_FOOT_ANALYSIS        = 'UPDATE_FOOT_ANALYSIS',
  DELETE_FOOT_ANALYSIS        = 'DELETE_FOOT_ANALYSIS',
  MANAGE_ANALYSIS_PHOTOS      = 'MANAGE_ANALYSIS_PHOTOS',
  ANNOTATE_PHOTO              = 'ANNOTATE_PHOTO',
}
